<header>
  <div class="header-wrapper">
    ...
    <div class="social-links">
      <a href="#" class="social"><img src="<?php echo esc_url( $fte_madden->get_special_directory_uri() ); ?>/img/twitter.svg" alt="Share on Twitter" /></a>
      <a href="#" class="social"><img src="<?php echo esc_url( $fte_madden->get_special_directory_uri() ); ?>/img/facebook.svg" alt="Share on Facebook" /></a>
    </div>
  </div>
</header>