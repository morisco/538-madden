<header>
  <div class="header-wrapper">
    <a class="logo" href="http://fivethirtyeight.com"><img class="words" src="<?php echo get_stylesheet_directory_uri(); ?>img/538-logo.png" alt="FiveThirtyEight Sports - Home" /><img class="fox" src="img/fox-logo.svg" alt="FiveThirtyEight Sports - Home" /></a>
    <nav>
